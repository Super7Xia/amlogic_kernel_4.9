...
// GNU C89 (Ubuntu/Linaro 5.4.0-6ubuntu1~16.04.4) version 5.4.0 20160609 (aarch64-linux-gnu)
...
// -D CONFIG_AS_LSE=1 -D CC_HAVE_ASM_GOTO
...
// -Werror=date-time -Werror=incompatible-pointer-types -std=gnu90 -p
...
.LASF12:
	.ascii	"GNU C89 5.4.0 20160609 -mlittle-endian -mgeneral-regs-only -"
	.ascii	"mpc-relative-literal-loads -mabi=lp64 -g -O2 -std=gnu90 -p -"
	.ascii	"fno-strict-aliasing -f"
	.string	"no-common -fno-asynchronous-unwind-tables -fno-pic -fno-delete-null-pointer-checks -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -fno-strict-overflow -fconserve-stack --param allow-store-data-races=0"
.LASF9:
	.string	"char"
.LASF10:
	.string	"long int"
...
.LASF0:
	.string	"signed char"
.LASF14:
	.string	"/home/wini/Buildroot/buildroot_openlinux/kernel/aml-4.9"
.LASF13:
